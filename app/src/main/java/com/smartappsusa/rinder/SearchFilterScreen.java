...
public class SearchFilterScreen extends AppCompatActivity implements View.OnClickListener{
    private Spinner cleanliness, sleepSchedule, noiseLevel, social, budget, hobbies;
    ...
    private void saveFilters(){
        ...
        database.collection("users").document(userId).update(filters).addOnSuccessListener(aVoid -> {
            Toast.makeText(SearchFilterScreen.this, "The Filter was saved successfully.", Toast.LENGTH_SHORT).show();
        }).addOnFailureListener(e -> {
            Toast.makeText(SearchFilterScreen.this, "Error with saving filters, please try again.", Toast.LENGTH_SHORT).show();
        });
    }
}
